        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                for (int bitPosition = 0; bitPosition < 8; bitPosition++)
                {
                    ...
                    {
                        n7 |= (1 << bitPosition);
                        n6 ^= (1 << bitPosition);   // or n6 &= -(1 << bitPosition);
                    }
                }
                for (int bitPosition = 0; bitPosition < 8; bitPosition++)
                {
                    ...
                    {
                        n6 |= (1 << bitPosition);
                        n5 ^= (1 << bitPosition);   // or n6 &= -(1 << bitPosition);
                    }
                }
                for (int bitPosition = 0; bitPosition < 8; bitPosition++)
                {
                    ...
                    {
                        n5 |= (1 << bitPosition);
                        n4 ^= (1 << bitPosition);   // or n6 &= -(1 << bitPosition);
                    }
                }
                for (int bitPosition = 0; bitPosition < 8; bitPosition++)
                {
                    ...
                    {
                        n4 |= (1 << bitPosition);
                        n3 ^= (1 << bitPosition);   // or n6 &= -(1 << bitPosition);
                    }
                }
                for (int bitPosition = 0; bitPosition < 8; bitPosition++)
                {
                    ...
                    {
                        n3 |= (1 << bitPosition);
                        n2 ^= (1 << bitPosition);   // or n6 &= -(1 << bitPosition);
                    }
                }
                for (int bitPosition = 0; bitPosition < 8; bitPosition++)
                {
                    ...
                    {
                        n2 |= (1 << bitPosition);
                        n1 ^= (1 << bitPosition);   // or n6 &= -(1 << bitPosition);
                    }
                }
                for (int bitPosition = 0; bitPosition < 8; bitPosition++)
                {
                    ...
                    {
                        n1 |= (1 << bitPosition);
                        n0 ^= (1 << bitPosition);   // or n6 &= -(1 << bitPosition);
                    }
                }
            }
